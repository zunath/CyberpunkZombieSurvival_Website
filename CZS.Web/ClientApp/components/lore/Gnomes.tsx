...
export default class Gnomes extends React.Component<any, any> {
        ...
        return (
            <div>
                <p>
                    ...
                    <br />
                    <br />
                    Much of their academia was geared towards the pursuit of new and inventive things; the arrival on Humanity and the AMP tech they brought with them was an exciting time for Gnomes. The promise of being able to enhance ones creativity and intelligence held spectacular appeal for them. Gnomish culture had a lax attitude towards mind altering drugs. In fact, many of them favoured such substances, as for them they represented a means to open your mind to new possibilities, and the addictions that came with their use were a small price to pay.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    Gnomes and Halflings shared a complex relationship. Perhaps the most similar in appearance to the Gnomes, the Halflings, nevertheless held philosophies and ideals that the Gnomes considered utterly alien to them. When a Gnome and a Halfling met, you would often get the impression that one did not quite know what to do with the other.
                </p>
