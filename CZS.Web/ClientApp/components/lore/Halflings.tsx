...
export default class Halflings extends React.Component<any, any> {
        ...
        return (
            <div>
                <p>
                    ...
                    <br />
                    <br />
                    The more adventurous of the Halflings learn about the wilds of Avantasia, taking forth their affinity for the natural world and applying it to gain understanding and mastery over the parts of their planet that are otherwise a dangerous place.
                    <br />
                    <br />
                    Their artwork consists mostly of tapestry depicting great landscapes, though artisty showing the importance of family and friends are also common. Architecturally, the Halflings build using wood and stone. Their dwellings are small, with farmlands on which to grow crops and raise livestock taking up most of their space. Gender plays no importance to Halfling society, as there are no biological differences in the strength, speed or intelligence between the sexes.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    In contrast to this though, Halflings love the idea of learning about and spending time with anyone they can, regardless of race. As storytelling is such a big part of their society, they love to know all they can about their planetary neighbours. One thing that the other races do love about Halflings is their ability to create the most beautiful culinary delicacies on the planet. Their produce and ales are highly sought after in other communities, as no farmer or brewer has ever quite managed to match the skill of a Halfling master of the trade.
                </p>
